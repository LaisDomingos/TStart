...
class P2 extends StatefulWidget {
  ...
  P2({required this.quantidadeTotal, required this.ajudante, required this.idCenario, required this.vitimaAtual});
  @override
  State<P2> createState() => _P2();
}
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              Ref_Gestao.get_definicao("TEXT_P2"),
              style: TextStyle(
                color: Colors.white,
